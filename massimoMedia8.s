; ricerca del massimo in un array di numeri e media dei valori versione 8
...
loop0:
	...
	DADDI r2, r2, 16		; i += 16 -> r2 contiene l'indirizzo di a[i+2]
	DADDI r1, r1, -2		; decrementa contatore ciclo di passo 2
	
	L.D f1, -8(r2)			; carica in f1 il valore di a[i+1] indirizzato da r2 + (16-8)
...
loop1:
	L.D f1, 0(r2)			; carica in f1 il valore di a[i+2] indirizzato da r2 + (16-0)	
	MFC1 r3, f0			; sposta il contenuto di f0 (FP reg)in r3 (INT reg)
	MFC1 r4, f1			; sposta il contenuto di f1 in r4
						; altrimenti errore nell'istruzione BEQ
	SLT r5, r4, r3		; r5 = 1 se r4==f1 < f0==r3 = max altrimenti r5 = 0
...
exit:					; ultimo loop
	L.D f1, 8(r2)		; carica in f1 il valore di a[n-1] indirizzato da r2 + 8	
	MFC1 r3, f0			; sposta il contenuto di f0 (FP reg)in r3 (INT reg)
	MFC1 r4, f1			; sposta il contenuto di f1 in r4
						; altrimenti errore nell'istruzione BEQ
	SLT r5, r4, r3		; r5 = 1 se r4==f1 < f0==r3 = max altrimenti r5 = 0
